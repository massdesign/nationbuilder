...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { height: @map.height, tileHeight: @map.tileHeight, tileWidth: @map.tileWidth, width: @map.width }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { height: @map.height, tileHeight: @map.tileHeight, tileWidth: @map.tileWidth, width: @map.width }
    assert_redirected_to map_path(assigns(:map))
  end
