...
class CurrenciesControllerTest < ActionController::TestCase
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post :create, currency: { convertable: @currency.convertable, name: @currency.name, status: @currency.status }
    end
  ...
  test "should update currency" do
    patch :update, id: @currency, currency: { convertable: @currency.convertable, name: @currency.name, status: @currency.status }
    assert_redirected_to currency_path(assigns(:currency))
  end
