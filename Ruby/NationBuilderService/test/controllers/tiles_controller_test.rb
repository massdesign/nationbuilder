...
class TilesControllerTest < ActionController::TestCase
  ...
  test "should create tile" do
    assert_difference('Tile.count') do
      post :create, tile: { xoffset: @tile.xoffset, xposition: @tile.xposition, yoffset: @tile.yoffset, yposition: @tile.yposition }
    end
  ...
  test "should update tile" do
    patch :update, id: @tile, tile: { xoffset: @tile.xoffset, xposition: @tile.xposition, yoffset: @tile.yoffset, yposition: @tile.yposition }
    assert_redirected_to tile_path(assigns(:tile))
  end
